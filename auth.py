...
from email_utils import enviar_email_de_redefinicao  # Certifique-se que este arquivo está na pasta
...
def show_login_form():
    """Exibe o formulário de login centralizado e com design atualizado."""
    ...
    <style>
        ...
        .forgot-password-link a {
            color: #0969da; font-size: 12px; text-decoration: none;
        }
